...
[![npm version](https://img.shields.io/npm/v/onesource-docs-mcp)](https://www.npmjs.com/package/onesource-docs-mcp)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](./LICENSE)
[![Node >= 18](https://img.shields.io/badge/node-%3E%3D18-brightgreen)](https://nodejs.org)

Give your AI assistant full access to the [OneSource Web3 API](https://docs.onesource.io) documentation — search docs, explore the GraphQL schema, and find working query examples for Ethereum, Base, Optimism, Avalanche, Sepolia, and Shape.

> **What is MCP?** The [Model Context Protocol](https://modelcontextprotocol.io) lets AI assistants call tools and access data sources. This server exposes OneSource documentation as 9 read-only tools — no API key or authentication needed.
...
- **CLI entry point** — `npx onesource-docs-mcp` just works, with `--port` support
...
**Maintainer:** [BlockParty](https://github.com/BlockPartyDev)
**Repository:** [1s-developer-docs](https://github.com/BlockPartyDev/1s-developer-docs/tree/develop/scripts/mcp-server)
**Security:** All tools are read-only — no authentication, no writes, no API keys required.
