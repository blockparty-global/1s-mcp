...
export function createMcpServer(opts) {
    ...
    // Wire HTTP-level analytics from client (default handler for non-overridden calls)
...
// Re-export for consumers that need transports
