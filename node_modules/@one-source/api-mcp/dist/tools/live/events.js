...
export const tool = {
    ...
    description: 'Query raw event logs via eth_getLogs directly from the node. ' +
        ...
        'WARNING: Keep block ranges small (10 blocks or fewer) to avoid huge responses. ' +
        'Always specify a contract address when possible. Omitting from_block/to_block queries only the latest block.',
    category: 'live',
    schema: {
