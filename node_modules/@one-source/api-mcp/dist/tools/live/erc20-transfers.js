...
export const tool = {
    ...
    description: 'Query ERC20 Transfer(from, to, value) event logs via eth_getLogs directly from the node. ' +
        'Filter by token contract and/or wallet address. Block params are hex-encoded (e.g. 0x1234). ' +
        'Returns decoded transfer events with sender, recipient, and value. ' +
        'WARNING: Keep block ranges small (10 blocks or fewer) to avoid huge responses. ' +
        'Omitting from_block/to_block queries only the latest block.',
    category: 'live',
    schema: {
